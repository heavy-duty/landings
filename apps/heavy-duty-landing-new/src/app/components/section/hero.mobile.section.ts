  ...
  template: `
    <section class="relative">
      ...
      <div class="flex justify-center mb-[]">
        <a href="https://solanaspain.dev" class=" bg-pixel-purple py-[2.2vw] px-[6.2vw] border-[0.6vw] border-black text-white text-[3.8vw]" target="_blank">JOIN THE BOOT CAMP</a>
      </div>
    </section>
      `,
  styles: ``,
