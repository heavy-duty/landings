...
@Component({
  selector: 'spain-tour-push-pin-icon',
  standalone: true,
  template: `
    <div class="w-full">
      <svg
      ...
      >
        <defs>
          ...
          >
            <stop
              offset="0"
              [attr.stop-color]="currentColorData.radialGradient.first"
              stop-opacity="0.68"
            />
            <stop
              offset="0.08"
              [attr.stop-color]="currentColorData.radialGradient.second"
              stop-opacity="0.61"
            />
            <stop
              offset="0.69"
              [attr.stop-color]="currentColorData.radialGradient.third"
              stop-opacity="0.17"
            />
          ...
          >
            <stop
              offset="0"
              [attr.stop-color]="currentColorData.radialGradient2.first"
            />
            <stop
              offset="1"
              [attr.stop-color]="currentColorData.radialGradient2.second"
            />
          </radialGradient>
          <radialGradient
          ...
          >
            <stop
              offset="0"
              [attr.stop-color]="currentColorData.radialGradient3.first"
            />
            <stop
              offset="0.53"
              [attr.stop-color]="currentColorData.radialGradient3.second"
            />
            <stop
              offset="0.72"
              [attr.stop-color]="currentColorData.radialGradient3.third"
            />
            <stop
              offset="0.86"
              [attr.stop-color]="currentColorData.radialGradient3.fourth"
            />
            <stop
              offset="0.97"
              [attr.stop-color]="currentColorData.radialGradient3.fifth"
            />
            <stop
              offset="1"
              [attr.stop-color]="currentColorData.radialGradient3.sixth"
            />
          </radialGradient>
          <radialGradient
          ...
          >
            <stop
              offset="0"
              [attr.stop-color]="currentColorData.radialGradient4.first"
            />
            <stop
              offset="0.3"
              [attr.stop-color]="currentColorData.radialGradient4.second"
            />
            <stop
              offset="0.41"
              [attr.stop-color]="currentColorData.radialGradient4.third"
            />
            <stop
              offset="0.49"
              [attr.stop-color]="currentColorData.radialGradient4.fourth"
            />
            <stop
              offset="0.5"
              [attr.stop-color]="currentColorData.radialGradient4.fifth"
            />
            <stop
              offset="0.62"
              [attr.stop-color]="currentColorData.radialGradient4.sixth"
            />
            <stop
              offset="1"
              [attr.stop-color]="currentColorData.radialGradient4.seventh"
            />
          </radialGradient>
        </defs>
        <ellipse
          class="{{ classPrefix }}-cls-11"
          cx="382.9"
          cy="703.78"
          rx="420"
          ry="345"
